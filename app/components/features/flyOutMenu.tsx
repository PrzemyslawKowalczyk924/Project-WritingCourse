        ...
        {isHovered && (
          <motion.div
            ...
            <div className="w-screen max-w-md flex-auto overflow-hidden rounded-b-3xl bg-white text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
              <div className="p-4">
                {solutions.map((item) => (
                  <div key={item.name} className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-mimi-pink">
                    <div className="mt-1 flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-lavenda-pink ">
