...
import { GiScrollQuill, GiLaurelsTrophy, GiTrophyCup, GiFingerPrint } from "react-icons/gi";
import { LiaFingerprintSolid, LiaUsersSolid, } from "react-icons/lia";
import { GrSend } from "react-icons/gr";

const solutions = [
  { name: 'Napisz historię marzeń', description: 'Czym jest kurs i do kogo jest skierowany?', href: '/course', id: '#course_Intro', icon: GiScrollQuill },
  { name: 'Wyzwania', description: 'Co będzie twoim zadaniem na kursie i co zyskasz dzięki niemu?', href: '/course', id: '#course_Enhance', icon: GiLaurelsTrophy },
  { name: 'Ślad', description: "Czyli jak pisać, aby porywać tłumy i pozostawić po sobie niezatarty ślad", href: '/course', id: '#course_Sight', icon: GiFingerPrint },
  { name: 'Integrcja', description: 'Przekonaj się, że w grupie jest nie tylko raźniej, ale owocniej', href: '/course', id: '#course_Enhance', icon: LiaUsersSolid },
  { name: 'Publikacja', description: 'Napisz swoją historię marzeń i pozwól, aby przeczytali ją inni!', href: '/course', id: '#course_Publication', icon: GrSend },
];
...
export default function Example() {
  ...
  return (
    <div className="relative my-auto h-full">
      ...
      <svg className='absolute' version="1.0" xmlns="http://www.w3.org/2000/svg"
        width="65" height="65" viewBox="0 0 1280.000000 1234.000000"
...
-82 32z"/>
      ...
      <motion.button
        ...
        className="pl-4 inline-flex items-center gap-x-px text-sm font-medium text-black absolute h-full border-gray-600"
      >
        <span className='pb-2'>kurs</span>
        ...
        {isHovered && (
          <motion.div
            ...
            <div className="w-screen max-w-md flex-auto overflow-hidden rounded-b-3xl bg-gray-800 text-sm leading-6 shadow-lg ring-1 ring-gray-900/5">
              <div className="p-4">
                {solutions.map((item) => (
                  <div key={item.name} className="group relative flex gap-x-6 rounded-lg p-4 hover:bg-gray-800 border-b-2 border-gray-800 bg-gray-900">
                    <div className="my-auto flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-800">
                    ...
                    <div className='mx-auto'>
                      ...
                      <a href={item.href + item.id} className="font-semibold text-white">
                        {item.name}
                        <span className="absolute inset-0" />
                      </a>
