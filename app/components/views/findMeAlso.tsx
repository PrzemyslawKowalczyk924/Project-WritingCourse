    ...
    return (
        <section className="bg-lavenda-pink py-24 sm:py-32 relative z-20 h-screen">
            <div className="flex flex-row mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div className="mx-auto mt-10 grid max-w-lg grid-cols-1 items-center gap-x-8 gap-y-10 sm:max-w-xl md:grid-cols-3 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
                    <a href="https://www.facebook.com/amelia.pudzianowska" target="_blank" rel="noreferrer" className="flex flex-row items-center justify-center">
                        <svg
                    ...
                    <a href="https://www.instagram.com/nizejpodpisana/" target="_blank" rel="noreferrer" className="flex flex-row items-center justify-center">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            className="h-7 w-7"
                            fill="currentColor"
