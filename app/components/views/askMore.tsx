    ...
    return (
        ...
        <section className="text-gray-600 body-font bg-mimi-pink z-30 relative">
            <div className="max-w-commonLayout px-5 py-24 mx-auto z-30">
                ...
                <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 2xs:p-12">
                    <div className="p-4 xs:w-full md:w-1/3 flex flex-col items-center 2sm:w-1/2 2xs:mb-7">
                        ...
                        <div className="flex-grow">
                            ...
                            <p className="leading-relaxed text-base mb-10 2xs:mb-5 2sm:text-sm sm:text-base">532 543 989</p>
                    ...
                    <div className="p-4 w-full xs:w-full md:w-1/3 flex flex-col items-center 2sm:w-1/2 2xs:mb-7">
                        <div className="w-12 h-12 xs:mx-10 inline-flex items-center justify-center rounded-full bg-lavenda-pink text-gray-800 mb-4 flex-shrink-0 md:mb-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="flex-grow">
                            ...
                            <p className="leading-relaxed text-base mb-10 2xs:mb-5 2sm:text-sm sm:text-base">amelia.pudzianowska@wp.pl</p>
                    ...
                    <div className="p-4 w-full xs:w-full md:w-1/3 flex flex-col items-center">
                        <div className="w-12 h-12 xs:mx-10 inline-flex items-center justify-center rounded-full bg-lavenda-pink text-gray-800 mb-4 flex-shrink-0 md:mb-6">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className="flex-grow">
                            ...
                            <p className="leading-relaxed text-base mb-10 2xs:mb-5 2sm:text-sm sm:text-base">Najczęściej zadawane pytania</p>
