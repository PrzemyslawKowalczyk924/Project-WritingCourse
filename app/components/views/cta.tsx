...
export default function CallToAction() {
    ...
    return (
        <section id='ctaId' className="bg-ctaBackground-pattern bg-cover bg-fixed bg-no-repeat bg-center md-max:h-140 h-screen dark:bg-gray-900 z-10 relative flex justify-center items-center flex-col">
