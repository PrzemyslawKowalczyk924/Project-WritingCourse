...
export default function CheckUpMyCourse() {
    ...
    return (
        <section ref={targetRef} className="text-gray-600 body-font h-[300vh] bg-cherry-pink z-30 relative shadowForBox ">
            ...
            {/* <img src={szkielet2} className="absolute bottom-20 -left-36 opacity-10" /> */}
                <div className="flex flex-col items-start justify-center lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0 p-14">
                    <video autoPlay muted loop className="checkUpCourseRadius-top mt-14 mb-7 opacity-75" src={doSyreny} />
                    <img src={napisacWiersz} className="checkUpCourseRadius-bottom shadow-2xl grayscale opacity-75" />
                </div>
