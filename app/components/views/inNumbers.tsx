const links = [
  ...
  const stats = [
    { name: 'Spotkania', value: '5' },
    { name: 'Godzina zegarowa zajęć', value: '1' },
    { name: 'Intensywne tygodnie zajęć', value: '3' },
    { name: 'Uczestników', value: '8' },
    { name: 'Satysfakcja', value: '100%' },
  ]
  ...
  export default function InNumbers() {
    return (
      <div className="relative isolate overflow-hidden bg-mimi-pink py-24 sm:py-32">
       {/*  <img
          src="https://images.pexels.com/photos/14129745/pexels-photo-14129745.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
          alt=""
          className="absolute inset-0 -z-10 h-full w-full object-cover object-right md:object-center grayscale contrast-50"
        />
        <div
            ...
            <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
              {stats.map((stat) => (
                <div key={stat.name} className="flex flex-col-reverse items-center justify-center last:col-span-4 last:mt-4">
                  ...
                  <dd className="text-5xl mb-3 font-bold leading-10 tracking-tight text-black">{stat.value}</dd>
                </div>
              ))}
            </dl>
          </div>
